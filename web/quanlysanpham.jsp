                            ...
                            <div class="box span12">
                                ...
                                <div class="box-content">
                                    <table class="table table-striped table-bordered bootstrap-datatable datatable">
                                        ...
                                        <%
                                            for (product c : dao.getAllProduct()) {
                                        %>
                                        <tr>
                                            <td class="center"><img style="height:100px"src="<%=c.getProductImage()%>" /></td>
                                            <td><%=c.getProductName()%> </td>
                                            <td class="center"><%=c.getProductPrice()%></td>
                                            <td class="center">
                                            ...
                                            <td class="center">
                                                ...
                                                <a class="btn btn-info" href="editproduct.jsp?product=<%=c.getProductID()%>">
                                                    <i class="halflings-icon white edit"></i>  
                                                </a>
                                                <a class="btn btn-danger"   href="deleteproduct.jsp?product=<%=c.getProductID()%>">
