...
<html lang="en">
    ...
    <body>
        ...
        <%
            userDAO pro = new userDAO();
            String id = "";
            user prod = new user();
            if (request.getParameter("product") != null) {
                id = request.getParameter("product");
                prod = pro.getUser(Long.parseLong(id));
            }
                            ...
                            <form method="post" action="editusers" enctype='multipart/form-data'>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="id" id="id" value="<%=prod.getUserID()%>" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="name" id="name" value="<%=prod.getFullname()%>" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="price" id="price"value="<%=prod.getUserPass()%>" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="email" id="image"  value="<%=prod.getUserEmail()%>" > 
                                    </td>
                                </tr>
                                <tr>
                                    <td> 
