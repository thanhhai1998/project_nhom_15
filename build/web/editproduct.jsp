                ...
                <div class="row-fluid">
                    ...
                    <div id="content" class="span10">
                        ...
                        <div class="row-fluid sortable">
                            <form method="post" action="editsanpham" enctype='multipart/form-data'>
                                <table>
                                    <tr>
                                        <td>
                                            id
                                        ...
                                        <td>
                                            <input type="text" name="id" id="id" value="<%=prod.getProductID()%>" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="name" id="name" value="<%=prod.getProductName()%>" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="price" id="price"value="<%=prod.getProductPrice()%>" >
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="image" id="image"  value="<%=prod.getProductImage()%>" > 
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select id="category_id" name="category_id"value="<%=prod.getCategoryID()%>">
                                            <%
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="submit"   name="command" class="btn btn-primary">Edit</button>
                                    </td>
                                </tr>
                            </table>
                        </form>
